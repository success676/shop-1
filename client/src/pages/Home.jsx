            ...
            <div className="container">
                <section className="faq">
                    ...
                    <div className="faq-item">
                        ...
                        >
                            <h3>Как я могу отследить свой заказ?</h3>
                            <span>{activeIndex === 2 ? "-" : "+"}</span>
                        </div>
                        {activeIndex === 2 && (
                            <div className="faq-content">
                                <p>
                                    Вы можете отследить свой заказ в личном
                                    кабинете на нашем сайте или по ссылке,
                                    которую мы отправим вам на электронную
                                    почту.
                                </p>
                            </div>
                        )}
